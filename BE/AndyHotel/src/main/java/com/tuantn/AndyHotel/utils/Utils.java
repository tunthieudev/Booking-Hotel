package com.tuantn.AndyHotel.utils;

import com.tuantn.AndyHotel.dto.BookingDTO;
...
public class Utils {
    ...
    private static final String ALPHANUMERIC_STRING = "ABCDEFGHIJKLMNOPQSTUVWXYZ0123456789";
    private static final SecureRandom secureRamdom = new SecureRandom();

    public static String generateRandomAlphanumeric(int length) {
        StringBuilder stringBuilder = new StringBuilder();
        for (int i = 0; i < length; i++) {
            int randomIndex = secureRamdom.nextInt(ALPHANUMERIC_STRING.length());
